...
public class FlightAppTeacher {
	...
	public static void main(String[] args) {
		...
		/*
		 * Integer depPlandTimeInteger = Integer.parseInt(depPlandTimeTemp); Double
		 * depPlandTimeDouble = Double.parseDouble(depPlandTimeTemp);
		 */
	
		int page = 1;
		/*
		 * String strTemp = depPlandTime + ""; String strTemp2 =
		 * depPlandTimeInteger.toString(); String strTemp3 =
		 * depPlandTimeDouble.toString();
		 */
